...
void main(){
	...
	texture2D(u_texture, v_texCoords+vec2(0,0.040))*0.0588+//0
	texture2D(u_texture, v_texCoords+vec2(0,0.030))*0.088+//1
	texture2D(u_texture, v_texCoords+vec2(0,0.020))*0.117+//2
	texture2D(u_texture, v_texCoords+vec2(0,0.010))*0.147+//3
	texture2D(u_texture, v_texCoords+vec2(0.0,0.0))*0.176+//4
	texture2D(u_texture, v_texCoords+vec2(0,0.010))*0.147+//3
	texture2D(u_texture, v_texCoords+vec2(0,0.020))*0.117+//2
	texture2D(u_texture, v_texCoords+vec2(0,0.030))*0.088+//1
	texture2D(u_texture, v_texCoords+vec2(0.0,040))*0.0588;//0
