 ...
 * @author mzechner
 * @author Nathan Sweet */
public class CustomSpriteBatchTwoUV implements Batch {
	...
	private int total_flush;

	/** Constructs a new SpriteBatch with a size of 1000, one buffer, and the default shader.
	 * @see CustomSpriteBatchTwoUV#CustomSpriteBatch(int, ShaderProgram) */
	public CustomSpriteBatchTwoUV () {
		this(1000, null);
	}

	/** Constructs a SpriteBatch with one buffer and the default shader.
	 * @see CustomSpriteBatchTwoUV#CustomSpriteBatch(int, ShaderProgram) */
	public CustomSpriteBatchTwoUV (int size) {
		this(size, null);
	}
	...
	public CustomSpriteBatchTwoUV (int size, ShaderProgram defaultShader) {
		...
		mesh = new Mesh(
			vertexDataType, false, size * 4, size * 6,
	...
	public void end_debug () {
		...
		Helper.log("TOTAL FLUSH "+total_flush);
	}
