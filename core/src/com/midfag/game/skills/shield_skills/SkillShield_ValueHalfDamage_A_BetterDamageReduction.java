...
public class SkillShield_ValueHalfDamage_A_BetterDamageReduction extends Skill {
	public float damage_reduction=0.5f;
	public float shield_condition=0.85f;
	
	public SkillShield_ValueHalfDamage_A_BetterDamageReduction()
	{
		super();
		...
		name="Усиленное укрепление: расширение";
		info="Усиливает укрепление"+"\n"+"бонус начинает работать с 75% щита";
	}
	
	@Override
	public void learn_action()
	{
			((SkillShield_ValueHalfDamage)parent).shield_condition=0.75f;
	}
}
